...
export default function AddBeforeStart() {
  ...
  const onSubmit= async (e)=>{
    ...
    await axios.post("http://localhost:8080/beforeStart", beforeStart)
    ...
    <div className='container'>
        <div className='row'>
            ...
            <div className="col-md-6 offset-md-3 border rounded p-4 mt-2">
                ...
                <h2 className="text-center m-4">Add an item</h2>
                ...
                <div className="mb-3">
                    ...
                    <input type={'text'} className="form-control" placeholder='Enter the item' name="item"  onChange={onInputChange}/>
                </div>
                <div className="mb-3">
                    <label htmlFor='State' className='form-label'>
                    State
                    </label>
                    <input type={'text'} className="form-control" placeholder='Enter the state' name="state" onChange={onInputChange}/>
                </div>
